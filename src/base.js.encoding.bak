(function() {
    ...
    function initStage() {
        ...
        var domContext = new Quark.DOMContext({
            canvas: container
        });
        ...
        stage = ns.stage = new Quark.Stage({
            container: container,
            width: width,
            height: height,
            context: domContext
    ...
    function initBalls() {
        ...
        var point = ns.point = new Quark.Bitmap({
            image: ns.Ball.images[0],
            rect: [0, 0, ns.r * 2, ns.r * 2],
            regX: ns.r,
            regY: ns.r
        });
